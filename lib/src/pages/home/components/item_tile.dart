...
import 'package:app_greengrocer/src/pages/product/prodcut_page.dart';
import 'package:app_greengrocer/src/services/utils_services.dart';
import 'package:flutter/material.dart';

class ItemTile extends StatefulWidget {
  final ItemModel item;
  final void Function(GlobalKey) carAnimationMethod;

  const ItemTile({
    Key? key,
    required this.item,
    required this.carAnimationMethod,
  }) : super(key: key);
            ...
            child: Material(
              child: InkWell(
                onTap: () {
                  ...
                  widget.carAnimationMethod(imageGk);
                },
                child: Ink(
                  height: 40,
                  width: 35,
