...
Map<int, Color> _swatchpacity = {
  ...
  700: const Color.fromRGBO(139, 195, 74, .7),
  800: const Color.fromRGBO(139, 195, 74, .8),
  900: const Color.fromRGBO(139, 195, 74, 1),
};

abstract class CustomColors {
  static Color customContrsatColor = Colors.red.shade700;
